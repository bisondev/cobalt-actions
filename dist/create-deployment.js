...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield octokit.rest.repos.createDeploymentStatus(Object.assign(Object.assign({}, context.repo), { deployment_id: deployment.data.id, state: initialStatus, log_url: logUrl, environment_url: url }));
