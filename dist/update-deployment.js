...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield octokit.rest.repos.createDeploymentStatus(Object.assign(Object.assign({}, context.repo), { deployment_id: parseInt(deploymentId), state, log_url: logUrl, target_url: url, environment_url: url }));
        }
        catch (error) {
            core.error(error);
